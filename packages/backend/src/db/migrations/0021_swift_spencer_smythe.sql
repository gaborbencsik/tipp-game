...
ALTER TABLE "match_market_data" ADD CONSTRAINT "match_market_data_match_id_matches_id_fk" FOREIGN KEY ("match_id") REFERENCES "public"."matches"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_match_market_data_match_fetched" ON "match_market_data" USING btree ("match_id","fetched_at");