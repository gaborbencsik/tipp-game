<template>
  <AppLayout>
    <div class="flex items-center justify-between mb-4">
      <h1 class="text-2xl font-bold text-gray-900">Globális stat tippek</h1>
    </div>
    ...
    <div v-else-if="store.globalTypes.length === 0" class="text-gray-500 text-sm">Még nincs globális stat tipp típus.</div>
    ...
    <div v-if="confirmDeactivateId !== null" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div class="bg-white rounded-xl p-6 shadow-xl max-w-sm w-full mx-4">
        <p class="text-gray-800 mb-4">Biztosan deaktiválod ezt a globális stat tipp típust?</p>
        <div class="flex gap-3 justify-end">
