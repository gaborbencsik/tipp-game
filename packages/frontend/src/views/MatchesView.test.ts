...
const MATCH_SCHEDULED: Match = {
  ...
  venue: { name: 'Stadium', city: 'Sao Paulo', country: null, imageUrl: null },
...
const MATCH_LIVE: Match = {
  ...
  venue: { name: 'Arena', city: 'Munich', country: null, imageUrl: null },
  league: DEFAULT_LEAGUE,
  stage: 'group',
  groupName: 'A',
  matchNumber: 1,
...
const DEFAULT_GROUP_WITH_LEAGUE = {
  ...
  createdBy: 'u1', memberCount: 2, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true,
  leagues: [{ id: 'l-default', name: 'Default League', shortName: 'DEF', status: 'active', type: 'mixed' }],
...
describe('MatchesView', () => {
  ...
  describe('US-958 phase filter visibility by league type', () => {
    function groupWithLeagueType(type: 'league' | 'cup' | 'mixed', id = 'l-x'): import('@/types/index').Group {
      return {
        ...
        createdBy: 'u1', memberCount: 2, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true,
        leagues: [{ id, name: id, shortName: id, status: 'active', type }],
        createdAt: '2026-01-01T00:00:00.000Z',
      } as unknown as import('@/types/index').Group
    }
  ...
  it('league select visible when >1 user-group league', async () => {
    mockGroupsGroups.push(
      { id: 'g1', name: 'A', description: null, inviteCode: 'X', inviteActive: true, createdBy: 'u1', memberCount: 2, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l1', name: 'World Cup 2026', shortName: 'WC26' }], createdAt: '2026-01-01T00:00:00.000Z' } as unknown as import('@/types/index').Group,
      { id: 'g2', name: 'B', description: null, inviteCode: 'Y', inviteActive: true, createdBy: 'u1', memberCount: 3, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l2', name: 'Euro 2026', shortName: 'EU26' }], createdAt: '2026-01-01T00:00:00.000Z' } as unknown as import('@/types/index').Group,
    )
    const { wrapper } = await mountView([MATCH_SCHEDULED])
  ...
  it('archived league is not offered as a filter option', async () => {
    mockGroupsGroups.push(
      { id: 'g1', name: 'A', description: null, inviteCode: 'X', inviteActive: true, createdBy: 'u1', memberCount: 2, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l1', name: 'World Cup 2026', shortName: 'WC26', status: 'active', type: 'league' }], createdAt: '2026-01-01T00:00:00.000Z' } as unknown as import('@/types/index').Group,
      { id: 'g2', name: 'B', description: null, inviteCode: 'Y', inviteActive: true, createdBy: 'u1', memberCount: 3, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l2', name: 'Euro 2026', shortName: 'EU26', status: 'active', type: 'league' }], createdAt: '2026-01-01T00:00:00.000Z' } as unknown as import('@/types/index').Group,
      { id: 'g3', name: 'C', description: null, inviteCode: 'Z', inviteActive: true, createdBy: 'u1', memberCount: 4, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l3', name: 'Old Cup 2022', shortName: 'OC22', status: 'archived' }], createdAt: '2026-01-01T00:00:00.000Z' } as unknown as import('@/types/index').Group,
    )
    const { wrapper } = await mountView([MATCH_SCHEDULED])
    const values = wrapper.find('[data-testid="league-filter"]').findAll('option').map(o => o.attributes('value'))
    expect(values).toContain('l1')
    expect(values).toContain('l2')
    expect(values).not.toContain('l3')
  })
  ...
  it('1 group with 1 league → leagueFilter auto-set to that league', async () => {
    mockGroupsGroups.push({
      ...
      createdBy: 'u1', memberCount: 2, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true,
      leagues: [{ id: 'l1', name: 'World Cup 2026', shortName: 'WC26', status: 'active', type: 'league' }],
      createdAt: '2026-01-01T00:00:00.000Z',
    })
    const { matchesStore } = await mountView([MATCH_SCHEDULED])
  ...
  it('2 groups with same league → leagueFilter auto-set to that league', async () => {
    mockGroupsGroups.push(
      { id: 'g1', name: 'A', description: null, inviteCode: 'X', inviteActive: true, createdBy: 'u1', memberCount: 2, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l1', name: 'WC', shortName: 'WC', status: 'active', type: 'league' }], createdAt: '2026-01-01T00:00:00.000Z' },
      { id: 'g2', name: 'B', description: null, inviteCode: 'Y', inviteActive: true, createdBy: 'u1', memberCount: 3, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l1', name: 'WC', shortName: 'WC', status: 'active', type: 'league' }], createdAt: '2026-01-01T00:00:00.000Z' },
    )
    const { matchesStore } = await mountView([MATCH_SCHEDULED])
    expect(matchesStore.leagueFilter).toBe('l1')
  })
  ...
  it('2 groups with different leagues → leagueFilter stays null', async () => {
    mockGroupsGroups.push(
      { id: 'g1', name: 'A', description: null, inviteCode: 'X', inviteActive: true, createdBy: 'u1', memberCount: 2, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l1', name: 'WC', shortName: 'WC', status: 'active', type: 'league' }], createdAt: '2026-01-01T00:00:00.000Z' },
      { id: 'g2', name: 'B', description: null, inviteCode: 'Y', inviteActive: true, createdBy: 'u1', memberCount: 3, isAdmin: false, userRank: null, favoriteTeamDoublePoints: false, scoringEnabled: true, leagues: [{ id: 'l2', name: 'Euro', shortName: 'EU', status: 'active', type: 'league' }], createdAt: '2026-01-01T00:00:00.000Z' },
    )
    const { matchesStore } = await mountView([MATCH_SCHEDULED])
    expect(matchesStore.leagueFilter).toBeNull()
  })
