...
describe('formatRelativeDeadline', () => {
  ...
  it('returns null when deadline is undefined', () => {
    expect(formatRelativeDeadline(undefined, now)).toBeNull()
  })

  it('returns null when deadline is empty string', () => {
    expect(formatRelativeDeadline('', now)).toBeNull()
  })

  it('returns null when deadline is invalid date string', () => {
