...
| US-004 | Production deploy pipeline | M | Must Have | ✅ Kész |
...
| US-303 | Profil szerkesztése | S | Should Have | ✅ Kész |
| US-304 | Email + jelszó auth | L | Should Have |
| US-305 | Session perzisztencia oldal-újratöltés után | S | Must Have | ✅ Kész |
...
| US-604-A | Csoport tagkezelés (admin) | S | Must Have | ✅ Kész |
| US-604-B | Meghívó kód kezelése (admin) | S | Must Have | ✅ Kész |
...
| UX-001 | Tipp input UX javítások (autosave, select, autonext) | S | Should Have | ✅ Kész |
